...
TEST(common, THRUST_VECTORING_SETPOINT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::THRUST_VECTORING_SETPOINT packet_in{};
    packet_in.time_boot_ms = 963497464;
    packet_in.target_system = 39;
    packet_in.target_component = 106;
    packet_in.coordinate_frame = 173;
    packet_in.type_mask = 19939;
    packet_in.servo_angle = {{ 45.0, 46.0, 47.0, 48.0, 49.0, 50.0 }};
    packet_in.thrust_body = {{ 213.0, 214.0, 215.0 }};
    packet_in.torque_body = {{ 297.0, 298.0, 299.0 }};

    mavlink::common::msg::THRUST_VECTORING_SETPOINT packet1{};
    mavlink::common::msg::THRUST_VECTORING_SETPOINT packet2{};
    ...
    EXPECT_EQ(packet1.coordinate_frame, packet2.coordinate_frame);
    EXPECT_EQ(packet1.type_mask, packet2.type_mask);
    EXPECT_EQ(packet1.servo_angle, packet2.servo_angle);
    EXPECT_EQ(packet1.thrust_body, packet2.thrust_body);
    EXPECT_EQ(packet1.torque_body, packet2.torque_body);
}

#ifdef TEST_INTEROP
TEST(common_interop, THRUST_VECTORING_SETPOINT)
{
    mavlink_message_t msg;
    ...
    mavlink_thrust_vectoring_setpoint_t packet_c {
    ...
    mavlink_msg_thrust_vectoring_setpoint_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.coordinate_frame, packet2.coordinate_frame);
    EXPECT_EQ(packet_in.type_mask, packet2.type_mask);
    EXPECT_EQ(packet_in.servo_angle, packet2.servo_angle);
    EXPECT_EQ(packet_in.thrust_body, packet2.thrust_body);
    EXPECT_EQ(packet_in.torque_body, packet2.torque_body);
